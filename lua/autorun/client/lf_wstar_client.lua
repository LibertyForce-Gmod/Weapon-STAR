...
local function WSTAR_Menu( )
	...
	Sheet:AddSheet( "Weapon Loadouts", Panel1, "icon16/arrow_refresh.png" )
	
		local b = vgui.Create( "DButton", Panel1 )
		local w, h = 300, 50
		...
		local t = vgui.Create( "DLabel", Panel1 )
		t:SetPos( 20, 130 )
		...
		local LoadoutList = vgui.Create( "DListView", Panel1 )
		...
		local LoadoutEntry = vgui.Create( "DTextEntry", Panel1 )
		...
		local c = vgui.Create( "DCheckBoxLabel", Panel1 )
		c:SetPos( 320, 370 )
	...
	Sheet:AddSheet( "Main Settings", Panel2, "icon16/table_gear.png" )	
		
		local t = vgui.Create( "DLabel", Panel2 )
		t:SetPos( 20, 20 )
		...
		local c = vgui.Create( "DCheckBoxLabel", Panel2 )
		c:SetPos( 20, 70 )
	...
	Sheet:AddSheet( "Weapon Transfer", Panel3, "icon16/package_go.png" )
		...
		local c = vgui.Create( "DCheckBoxLabel", Panel3 )
		c:SetPos( 20, 70 )
		...
		local b = vgui.Create( "DButton", Panel3 )
		b:SetPos( 20, 500 )
		b:SetSize( 150, 50 )
		...
		local MapEntry = vgui.Create( "DTextEntry", Panel3 )
	...
	Sheet:AddSheet( "About", Panel9, "icon16/help.png" )
	
		local t = vgui.Create( "DLabel", Panel9 )
		t:SetPos( 20, 20 )
		...
		t:SetDark( true )
		t:SetFont( "DermaDefaultBold" )
		t:SetText( "Created by Liberty Force." )
		t:SetWrap( true )
		...
		local b = vgui.Create( "DButton", Panel9 )
		b:SetPos( 20, 190 )
		b:SetSize( 120, 25 )
